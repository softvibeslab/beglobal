...
def source_inventory():
    candidates = [HERE / "workspace.py", HERE / "telegram_initdata.py", HERE / "test_workspace.py", HERE / "test_telegram.py", HERE / "test_link.py", HERE / "test_session.py", HERE / "test_unlink.py", HERE / "test_mission.py", HERE / "playwright.config.cjs", HERE / "package.json", HERE / "package-lock.json", HERE / "requirements.txt", HERE / "requirements.lock.txt"]
...
def main():
    ...
    results = {
        ...
        "backend": command("backend", [python, "-m", "unittest", "-v", "test_workspace.py", "test_telegram.py", "test_link.py", "test_session.py", "test_unlink.py", "test_mission.py"], HERE),
    ...
    report = {"recorded_at": datetime.now(timezone.utc).isoformat(), "scope": "SP-006 local fixture mission create/read without route progress or member-accepted status",
