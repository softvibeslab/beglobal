...
# Public/direct Drive file links without OAuth: large files may first return
# a virus-scan warning HTML page. If using curl/requests, parse the confirmation
# form and retry against https://drive.usercontent.google.com/download with the
# hidden fields id, export=download, confirm, and uuid, then verify the binary.
